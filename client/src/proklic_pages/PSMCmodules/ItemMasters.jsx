...
const ItemMasters = () => {
  ...
  const handleChangeEdit = (event) => {
    setCheckedEdit({ ...checkedView, [event.target.name]: event.target.checked });
  };
  const [checkedAdd, setCheckedAdd] = React.useState({});
  const handleChangeAdd = (event) => {
    setCheckedAdd({ ...checkedView, [event.target.name]: event.target.checked });
  };
  const [checkedDelete, setCheckedDelete] = React.useState({});
  const handleChangeDelete = (event) => {
    setCheckedDelete({ ...checkedView, [event.target.name]: event.target.checked });
  };
  ...
  const tableColumns = [
    ...
    },
    {
      title: "Edit", field: "edit", render: (rowdata) => (
        <input type="checkbox" name={rowdata.id} checked={checkedEdit[rowdata.id]} onChange={handleChangeEdit} />
      )
    },
    {
    ...
    },
    {
      title: "Delete", field: "delete", render: (rowdata) => (
        <input type="checkbox" name={rowdata.id} checked={checkedDelete[rowdata.id]} onChange={handleChangeDelete} />
      )
    },
