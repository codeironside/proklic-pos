...
const ComboMeals = () => {
    ...
    const [comboGroup, setComboGroup] = React.useState('');

    const handleChangeComboGroup = (event) => {
      setComboGroup(event.target.value);
    };

    const [comboMeal, setComboMeal] = React.useState('');

    const handleChangeComboMeal = (event) => {
      setComboMeal(event.target.value);
    };
    ...
    const handleFormSubmit = (values) => {
        ...
        const combinedObject = { ...values, ...comboGroup, ...comboMeal }
            ...
            >
                <Box sx={style}>
                    <Typography id="keep-mounted-modal-title" variant="h3" component="h2" sx={{ mb: 4 }}>
                        <strong> Create Combo Meals </strong>
                    </Typography>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <Grid container spacing={3} >
                                        ...
                                        <FormControl sx={{ minWidth: 280 }} size="small">
                                            <InputLabel id="Combo_group-label">Combo Group</InputLabel>
                                            <Select
                                                labelId="Combo_group-label"
                                                id="combo_group"
                                                value={comboGroup}
                                                label="comboGroup"
                                                onChange={handleChangeComboGroup}
                                            >
                                                <MenuItem value="">
                                                <em>None</em>
                                                </MenuItem>
                                        ...
                                        <Grid item xs={12} md={12}>
                                        <FormControl sx={{ minWidth: 280 }} size="small">
                                            <InputLabel id="comboMeal-label">Combo Meal</InputLabel>
                                            <Select
                                                labelId="comboMeal-label"
                                                id="comboMeal"
                                                value={comboMeal}
                                                label="comboMeal"
                                                onChange={handleChangeComboMeal}
                                            >
                                                <MenuItem value="">
                                                <em>None</em>
                                                </MenuItem>
