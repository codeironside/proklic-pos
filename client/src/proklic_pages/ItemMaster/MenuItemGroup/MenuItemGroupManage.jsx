...
const tableColumns = [
    ...
    { title: "Role ID", field: "roleID", validate: rowData => rowData.roleID === '' ? 'Role ID cannot be empty' : '',  },
    ...
    { title: "Parent Category", field: "parentCategory" , validate: rowData => rowData.parentCategory === '' ? 'Parent Category cannot be empty' : '', },
    // { title: "Menu ID", field: "menuID" },
    // { title: "Menu Item Category", field: "menuItemCategory" },
    // { title: "Menu Item Group", field: "menuItemGroup" },
...
export default MenuItemGroupManage